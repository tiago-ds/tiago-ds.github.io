		...
		<div className="main-section d-flex flex-column-reverse flex-lg-row align-items-center m-5 gap-5 rounded-5 p-5">
			<div className="text-section d-flex flex-column m-1">
				...
				<p className="regular-text">
					I am Tiago, a Fullstack Developer with a passion for
					creating and developing web applications. I am currently
					engaged in a bachelor's for Computer Science and I like to
					learn new technologies. Also, I like purple a lot.
				</p>
			</div>
			<img
